        ...
        {currentSection === "overview" && (
          <div className="row g-4">
            <div className="col-md-3">
              <div className="card bg-black h-100 text-center p-4">
                <h2 className="text-purple">{stats.total_users}</h2>
                <small>Total Users</small>
              </div>
            </div>
            <div className="col-md-3">
              <div className="card bg-black h-100 text-center p-4">
                <h2 className="text-success">{stats.customers}</h2>
                <small>Customers</small>
              </div>
            </div>
            <div className="col-md-3">
              <div className="card bg-black h-100 text-center p-4">
                <h2 className="text-warning">{stats.owners}</h2>
                <small>Owners</small>
              </div>
            </div>
            <div className="col-md-3">
                    ...
                    {loading ? (
                      ...
                      users.map((user) => (
                        <tr key={user.id}>
                          ...
                          <td>
                            <span
                              className={`badge ${user.role === "admin" ? "bg-danger" : user.role === "owner" ? "bg-warning" : "bg-success"}`}
                            >
                              {user.role}
                            </span>
                          </td>
